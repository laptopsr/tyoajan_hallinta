...
*/
	...
	$criteria->group = 'kuka';
	$tar = Tilausvahvistukset::model()->findAll($criteria);
...
foreach($tar as $val){
  ...
  if($val->kuka){
	$tarByUser = Tilausvahvistukset::model()->findAll("kuka = :n", array(":n"=>$val->kuka));
...
for ($i = 1; $i <= 12; $i++) {
	...
	$result = Tilausvahvistukset::model()->findAll($criteria);
...
<h1>TILAUSVAHVISTUS RAPORTIT</h1>

<div class="row">
  <div class="col-sm-6">
  <h2>Tilausvahvistukset kuukausittain</h2>
  ...
  <div class="col-sm-6">
  <h2>Kaikki tilausvahvistuksen luojat</h2>
  <?php 
            $this->widget(
...
$(".keskeyta").click(function(){
	var link = "index.php?r=site/tv_raports";
   	window.location.href=link;
});

$(".luojaValikko").change(function(){
	var link = "index.php?r=site/tv_raports&luoja="+$(this).val();
   	window.location.href=link;
});
...
<?php 
	...
	echo '<h1>RAPORTIT</h1><BR><h1>Ei yhtään tilausvahvistusta tällä hetkellä</h1>';
}
?>
